...
public class Listeners_Tests extends WebListener{
...
("--no-sandbox","--ignore-certificate-errors","--homepage=about:blank","--no-first-run"));
        ...
        WebListener eCapture = new WebListener();
        ...
        eventRecorder.navigate().to("https://www.google.com");
         eventRecorder.manage().window().maximize();
        //Event Two
        ...
        eventRecorder.findElement(By.xpath("//*[contains(text(),'click here')]")).click();
